...
class AppController extends ChangeNotifier {
  static AppController instance =
      AppController(); //define a classe estatica dela mesma
  ...
  changeThema() {
    //metodo para modificar o tema
    temaDaAplicacao =
        !temaDaAplicacao; //recebe o contrario se for true vai para false e virce e versa
